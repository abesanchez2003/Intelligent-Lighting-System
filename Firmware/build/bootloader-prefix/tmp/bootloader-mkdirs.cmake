...
if(NOT EXISTS "/Users/abe/esp/v5.5.1/esp-idf/components/bootloader/subproject")
  file(MAKE_DIRECTORY "/Users/abe/esp/v5.5.1/esp-idf/components/bootloader/subproject")
endif()
file(MAKE_DIRECTORY
...
endforeach()
if(cfgdir)
  file(MAKE_DIRECTORY "/Users/abe/capstone/Intelligent-Lighting-System/Firmware/build/bootloader-prefix/src/bootloader-stamp${cfgdir}") # cfgdir has leading slash
endif()
